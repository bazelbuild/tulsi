...
final class TulsiGeneratorConfigDocument: NSDocument,
  ...
  override func makeWindowControllers() {
    ...
    let windowController = storyboard.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier("TulsiGeneratorConfigDocumentWindow")) as! NSWindowController

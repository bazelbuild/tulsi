  ...
  def _UsageMessage(self):
    ...
    usage = textwrap.dedent("""\
      ...
      Where options are:
        ...
        --rc <bazelrc_path>
            Provides a .bazelrc to use for this build.
  ...
  def _ParseVariableOptions(self, args):
    ...
    while args:
      ...
      if arg == '--noverbose':
        ...
        args, value_or_message = self._ConsumeArgumentForParam('--rc', args)
        if args is None:
          return (value_or_message, 2)
        config = self._ParseConfigFilter(arg)
        self.startup_options[config].append('--bazelrc=%s' % value_or_message)
